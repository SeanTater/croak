...
vocab_size = 96  # Only consider the top 96 characters
...
subsample_slices = 17 # How many characters to skip forward in each article for each slice
...
def generate_music_batch(size=1):
